...
const MSIRegistration = () => {
        ...
        },
        {
            ...
            renderCell: (params) => (
                <Box display="flex" justifyContent="space-between">
                    ...
                    <Link href={`/item/msi-registration/form/${params.row.id_item}`} passHref>
    ...
    return (
        <Grid container spacing={6}>
            <PageHeader
                title={<Typography variant='h5'>MSI Registration</Typography>}
                subtitle={<Typography variant='body2'>List of all MSI registrations</Typography>}
            />
            <Grid item xs={12}>
                <Card>
                    <Box
                    ...
                    >
                        <Button sx={{ mb: 2.5 }} component={Link} variant='contained' href='/item/msi-registration/form' size='small'>
                            Create Menu
                        </Button>
                        <TextField
                            type={'search'}
...
MSIRegistration.acl = {
    action: 'manage',
    subject: 'msi-registration'
};

export default MSIRegistration;
