...
const SUJFormRegistration = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            console.log('response data', itemResponse.data)
            if (token) {
    ...
    const handleJustSubmit = async (event, status) => {
        ...
        try {
            ...
            router.push('/item/suj-registration');
        } catch (error) {
            console.error(error);
        } finally {
            setLoading(false);
                ...
                <form onSubmit={(e) => handleSubmit(e, 1)}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <Button variant='outlined' onClick={() => router.push('/item/suj-registration')}>
                                Back
                            </Button>
