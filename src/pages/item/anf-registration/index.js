...
return (
        ...
        },
        {
            ...
            renderCell: (params) => (
                <Box display="flex" justifyContent="space-between">
                    ...
                    <Link href={`/item/anf-registration/form/${params.row.id_item}`} passHref>
    ...
    return (
        <Grid container spacing={6}>
            <PageHeader
                title={<Typography variant='h5'>ANF Registration</Typography>}
                subtitle={<Typography variant='body2'>List of all ANF registrations</Typography>}
            />
            <Grid item xs={12}>
                <Card>
                    <Box
...
AFRegistration.acl = {
    action: 'manage',
    subject: 'anf-registration'
};

export default AFRegistration;
